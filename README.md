...
1) Deploying Configurations of Virtual Machine instances in AWS servers which otherwise would have to be done manually. This saves considerable time and effort for DevOps engineers.  
